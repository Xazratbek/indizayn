  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="max-w-[90vw] max-h-[90vh] w-auto h-auto p-0 bg-transparent border-0 flex items-center justify-center">
        <DialogTitle className="sr-only">Kattalashtirilgan rasm</DialogTitle>
        <DialogDescription className="sr-only">Loyiha rasmining to'liq ekranli ko'rinishi.</DialogDescription>
