  ...
  return (
    <Dialog open={!!projectId} onOpenChange={(open) => !open && onClose()}>
      <AnimatePresence>
        {!!projectId && (
          <DialogContent
            className="w-full h-full max-w-none p-0 bg-transparent border-0 shadow-none flex justify-center items-center"
            onClick={onClose}
          >
              ...
              <div className="h-full w-full max-w-6xl" onClick={(e) => e.stopPropagation()}>
